...
function setUpPhong(program) {
  ...
  let ambientLightSetting = glMatrix.vec3.fromValues(0.8, 0.3, 0.5)
  gl.uniform3fv(program.ambientLight,ambientLightSetting)


  let lightPositionSetting=glMatrix.vec3.fromValues(100,100,100)
  // var lightPosition = gl.getUniformLocation(program, "lightPosition");
  gl.uniform3fv(program.lightPosition, lightPositionSetting);
  ...
  let baseColorSettings = glMatrix.vec3.fromValues(``, 1, 2);
  gl.uniform3fv(program.baseColor, baseColorSettings);
...
function setUpCamera(program) {
  ...
  glMatrix.mat4.perspective(projMatrix,radians(45),1.0,1.0,400)
  // glMatrix.mat4.ortho(projMatrix, -5, 5, -5, 5, 1.0, 300.0);
  gl.uniformMatrix4fv(program.uProjT, false, projMatrix);

  let viewMatrix = glMatrix.mat4.create();
  glMatrix.mat4.lookAt(viewMatrix, [7, 0, 1], [0, -1, 0], [0, 1, 0]);
